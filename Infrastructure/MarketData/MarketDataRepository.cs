...
namespace BinanceTradingBot.Infrastructure.MarketData
{
    public class MarketDataRepository : IMarketDataRepository
    {
        ...
        public async Task<List<BinanceTradingBot.Domain.Entities.CandlestickData>> GetCandlestickDataAsync(string symbol, string interval, int limit)
        {
            ...
            return await _binanceApiService.GetCandlestickDataAsync(symbol, interval, limit);
        }
    }
}